...
public class TogglingWindow : Window, IPointerDownHandler
{
    ...
    [SerializeField] private bool changeSortingOrderOption;                         //if value is true : window's SortingOrder can be changed by Click
    ...
    protected override void Awake()
    {
        ...
        if ((changeSortingOrderOption == true) && !(GetComponent<Canvas>())) gameObject.AddComponent<Canvas>();          //About ClickOption
    ...
    protected virtual void OnEnable()
    {
        ...
        if (inputDisabledOption) SingletonTable.singletonTable.kiM.InputDisabledWindowStackUp();
    ...
    protected virtual void OnDisable()
    {
        ...
        if (inputDisabledOption) SingletonTable.singletonTable.kiM.InputDisabledWindowStackDown();
    }
    ...
    public void OpenWindow()
    {
        ...
        SingletonTable.singletonTable.uwM.SetWindowSortingOrderToTop(this);
    ...
    public void CloseWindow()
    {
        ...
        {
            isActive = false;
            SingletonTable.singletonTable.uwM.RemoveWindowFromWindowList(this);
    ...
    {
        if (changeSortingOrderOption) SingletonTable.singletonTable.uwM.SetWindowSortingOrderToTop(this);
    }
