...
public class SingletonTable : MonoBehaviour
{
    public static SingletonTable singletonTable { get; private set; }  //ManagerGrouping is singleton
    ...
    {
        if (SingletonTable.singletonTable == null)
        {
            SingletonTable.singletonTable = this;
        }
    }
}
